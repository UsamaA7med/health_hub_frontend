...
import { addToast, Button, Card, CardBody, Image } from '@heroui/react'
...
const Doctor = () => {
  const { id } = useParams()
  const { getDoctor, doctor, getFilteredDoctors } = useAdmin()
  const {
    createAppointment,
    doctorAppointments,
      ...
      <div className="grid grid-cols-1 gap-5 md:grid-cols-6 items-stretch">
        ...
        <div className="col-span-5 flex flex-col gap-10">
              ...
              <div className="flex flex-col gap-3">
                ...
                <div className="flex gap-3 flex-wrap">
                  {timeSlots.map((slot) => (
                    ...
                    >
                      <p className="text-sm">{formatTimeDisplay(slot.time)}</p>
                    </div>
                  ))}
                </div>
              </div>
          ...
          <Button
            ...
            isDisabled={!selectedDay || !selectedHour || isCreatingAppointment}
